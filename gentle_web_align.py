...
if __name__ == '__main__':
    ...
    if (arguments['--nested-directories'] is None) or (arguments['--nested-directories']==[]):
        wav_paths = sorted(glob.glob(arguments['--wav_pattern'][0]))
        txt_paths = sorted(glob.glob(arguments['--txt_pattern'][0]))    
